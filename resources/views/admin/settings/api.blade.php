...
<div class="space-y-6 sm:space-y-8 pb-20 px-1 sm:px-0">
    <div class="bg-white rounded-[2rem] sm:rounded-[3rem] border border-slate-100 shadow-sm overflow-hidden p-6 sm:p-12">
            ...
            <div class="space-y-5 sm:space-y-6">
                ...
                <div class="space-y-4">
                    <div class="space-y-1.5 sm:space-y-2">
                        ...
                        <input type="password" value="XXXXXXXX-XXXX-XXXX-XXXX" class="w-full px-5 sm:px-8 py-3.5 sm:py-4 bg-slate-50 border-none rounded-xl sm:rounded-2xl text-[10px] sm:text-sm font-mono outline-none focus:ring-2 focus:ring-rdc-blue/20">
                    </div>
                    <div class="space-y-1.5 sm:space-y-2">
                        <label class="text-[8px] sm:text-[10px] font-black text-slate-400 uppercase tracking-widest ml-3 sm:ml-4">Secret Key</label>
                        <input type="password" value="S3CR3T_K3Y_V4LU3" class="w-full px-5 sm:px-8 py-3.5 sm:py-4 bg-slate-50 border-none rounded-xl sm:rounded-2xl text-[10px] sm:text-sm font-mono outline-none focus:ring-2 focus:ring-rdc-blue/20">
                    </div>
                </div>
            </div>
+
            ...
            <div class="space-y-5 sm:space-y-6">
                ...
                <div class="space-y-4">
                    <div class="space-y-1.5 sm:space-y-2">
                        ...
                        <input type="text" placeholder="Clé Google..." class="w-full px-5 sm:px-8 py-3.5 sm:py-4 bg-slate-50 border-none rounded-xl sm:rounded-2xl text-[10px] sm:text-sm font-mono outline-none focus:ring-2 focus:ring-rdc-blue/20">
                    </div>
                </div>
            </div>
+
            <div class="pt-6 sm:pt-10 flex justify-end">
                <button class="w-full sm:w-auto px-10 py-4 sm:py-5 bg-slate-900 text-white font-black rounded-xl sm:rounded-2xl text-[9px] sm:text-[10px] uppercase tracking-widest shadow-2xl shadow-slate-200 hover:bg-rdc-blue active:scale-95 transition-all">Enregistrer</button>
            </div>
        </div>
        </div>
</div>
