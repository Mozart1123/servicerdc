            ...
            <div class="w-full lg:w-72 shrink-0 {{ $isAccountPage ? 'block' : 'hidden lg:block' }}">
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden lg:sticky lg:top-24">
                    ...
                    <div class="p-6 border-b border-slate-50 flex items-center gap-4">
                        <img src="{{ auth()->user()->photo_url ?? 'https://ui-avatars.com/api/?name='.urlencode(auth()->user()->name).'&color=29B6D1&background=e0f2f1' }}" class="w-14 h-14 rounded-full border-2 border-rdc-blue object-cover">
                        <div>
                            <p class="font-bold text-slate-800 text-lg leading-tight">{{ auth()->user()->name }}</p>
                            <p class="text-xs text-rdc-blue font-medium mt-0.5">Espace Client</p>
                        </div>
                    </div>
                    ...
                    <div class="p-4 space-y-6 lg:space-y-8" id="sidebar-nav-menu">
                        ...
                        <div>
                            ...
                            <div class="space-y-2 lg:space-y-1">
                                ...
                                <div class="nav-item-wrapper">
                                    <a href="{{ route('user.dashboard') }}" class="is-nav-link flex items-center justify-between px-4 py-3 lg:py-2.5 rounded-xl text-sm font-medium transition-colors {{ $isDashboard ? 'is-active-nav bg-rdc-blue/10 text-rdc-blue' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                                        <div class="flex items-center gap-3">
                                            <i class="fas fa-border-all w-5 text-center {{ $isDashboard ? 'text-rdc-blue' : 'text-slate-400' }}"></i> Tableau de bord
                                        </div>
                                ...
                                <div class="nav-item-wrapper">
                                    <a href="{{ route('user.profile') }}" class="is-nav-link flex items-center justify-between px-4 py-3 lg:py-2.5 rounded-xl text-sm font-medium transition-colors {{ $isProfile ? 'is-active-nav bg-rdc-blue/10 text-rdc-blue' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                                        <div class="flex items-center gap-3">
                                            <i class="fas fa-user w-5 text-center {{ $isProfile ? 'text-rdc-blue' : 'text-slate-400' }}"></i> Profil
                                        </div>
                                        <i class="fas fa-chevron-right lg:hidden text-slate-400 transition-transform duration-300"></i>
                                    </a>
                                </div>
                                ...
                                <div class="nav-item-wrapper">
                                    <a href="{{ route('user.security') }}" class="is-nav-link flex items-center justify-between px-4 py-3 lg:py-2.5 rounded-xl text-sm font-medium transition-colors {{ $isSecurity ? 'is-active-nav bg-rdc-blue/10 text-rdc-blue' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                                        <div class="flex items-center gap-3">
                                            <i class="fas fa-shield-alt w-5 text-center {{ $isSecurity ? 'text-rdc-blue' : 'text-slate-400' }}"></i> Sécurité
                                        </div>
                                        <i class="fas fa-chevron-right lg:hidden text-slate-400 transition-transform duration-300"></i>
                                    </a>
                                </div>
                                ...
                                <div class="nav-item-wrapper">
                                    <a href="{{ route('user.report') }}" class="is-nav-link flex items-center justify-between px-4 py-3 lg:py-2.5 rounded-xl text-sm font-medium transition-colors {{ $isReport ? 'is-active-nav bg-rdc-blue/10 text-rdc-blue' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                                        <div class="flex items-center gap-3">
                                            <i class="fas fa-cog w-5 text-center {{ $isReport ? 'text-rdc-blue' : 'text-slate-400' }}"></i> Paramètres & Aide
                                        </div>
                                        <i class="fas fa-chevron-right lg:hidden text-slate-400 transition-transform duration-300"></i>
                                    </a>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-2 lg:space-y-1">
                                ...
                                @endphp
                                <div class="nav-item-wrapper">
                                    <a href="{{ route('user.service-requests.index') }}" class="is-nav-link flex items-center justify-between px-4 py-3 lg:py-2.5 rounded-xl text-sm font-medium transition-colors {{ $isRequests ? 'is-active-nav bg-rdc-blue/10 text-rdc-blue' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                                        <div class="flex items-center gap-3">
                                            <i class="fas fa-clipboard-list w-5 text-center {{ $isRequests ? 'text-rdc-blue' : 'text-slate-400' }}"></i> Mes demandes
                                            @if($reqCount > 0)
                                                <span class="bg-rdc-blue/10 text-rdc-blue text-[10px] font-bold px-2 py-0.5 rounded-full ml-1">{{ $reqCount }}</span>
                                            @endif
                                        </div>
                                        <i class="fas fa-chevron-right lg:hidden text-slate-400 transition-transform duration-300"></i>
                                    </a>
                                ...
                                <div class="nav-item-wrapper">
                                    <a href="{{ route('user.messages.index') }}" class="is-nav-link flex items-center justify-between px-4 py-3 lg:py-2.5 rounded-xl text-sm font-medium transition-colors {{ $isMessages ? 'is-active-nav bg-rdc-blue/10 text-rdc-blue' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                                        <div class="flex items-center gap-3">
                                            <i class="fas fa-envelope w-5 text-center {{ $isMessages ? 'text-rdc-blue' : 'text-slate-400' }}"></i> Messages
                                        </div>
                                        <i class="fas fa-chevron-right lg:hidden text-slate-400 transition-transform duration-300"></i>
                                    </a>
                                </div>
                                ...
                                <div class="nav-item-wrapper">
                                    <a href="{{ route('user.jobs.index') }}" class="is-nav-link flex items-center justify-between px-4 py-3 lg:py-2.5 rounded-xl text-sm font-medium transition-colors {{ $isJobs ? 'is-active-nav bg-rdc-blue/10 text-rdc-blue' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                                        <div class="flex items-center gap-3">
                                            <i class="fas fa-briefcase w-5 text-center {{ $isJobs ? 'text-rdc-blue' : 'text-slate-400' }}"></i> Emplois & Candidatures
                                        </div>
                                        <i class="fas fa-chevron-right lg:hidden text-slate-400 transition-transform duration-300"></i>
                                    </a>
                                </div>
                                ...
                                <div class="nav-item-wrapper">
                                    <a href="{{ route('user.favorites') }}" class="is-nav-link flex items-center justify-between px-4 py-3 lg:py-2.5 rounded-xl text-sm font-medium transition-colors {{ $isFavorites ? 'is-active-nav bg-rdc-blue/10 text-rdc-blue' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                                        <div class="flex items-center gap-3">
                                            <i class="fas fa-heart w-5 text-center {{ $isFavorites ? 'text-rdc-blue' : 'text-slate-400' }}"></i> Favoris
                                        </div>
                                        <i class="fas fa-chevron-right lg:hidden text-slate-400 transition-transform duration-300"></i>
                                    </a>
                                </div>
